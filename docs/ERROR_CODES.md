...
| LARA-QUALITY-001 | `LARA-QUALITY-001` | P5 corpus structure, diversity or one case execution is invalid | Restore the versioned corpus, verify model/memory/output paths and rerun | `tools/quality` |
